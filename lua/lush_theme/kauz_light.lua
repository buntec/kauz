...
-- terminal colors
local terminal_br = 80 -- how much to brighten the 'br' terminal colors
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    LualineReplaceA { fg = fg, bg = bg.darken(15) },
    LualineReplaceB { fg = fg, bg = bg.darken(10) },
    LualineReplaceC { fg = fg, bg = bg.darken(5) },
    LualineCommandA { fg = c1, bg = bg.darken(15) },
    LualineCommandB { fg = fg, bg = bg.darken(10) },
    LualineCommandC { fg = fg, bg = bg.darken(5) },
